...
volatile uint8 last_air_conditioning_value=AIR_CONDTIONING_OFF; // last air conditioning value which will help in hysteresis ( less Maintenance )
...
int main(void)
{
	...
	/* initialization of output pins of connected leds or devices ( Simulation ) */
